...
def main():
    ...
    out_df = df.copy()
    out_df['tsne_0'] = transformed_full_list[:, 0]
    out_df['tsne_1'] = transformed_full_list[:, 1]
    out_df = out_df[['model', 'lang', 'prompt_type', 'prompt_param', 'temperature', 'study_group', 'tsne_0', 'tsne_1', 'recs']]
